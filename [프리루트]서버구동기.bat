@echo off
title 마인크래프트 1.11.2 스폰지 모드버킷 with 프리루트
:main
cls
echo.
echo ┍──────────────────────────────
echo │
echo │     프리루트의 마인크래프트 1.11.2 스폰지 모드버킷
echo │
echo │
...
echo │
echo │
echo │  * 핵심파일 제작 : Sponge / 구동기 제작 : 프리루트(FreeRoute) 
echo │  * 핵심파일 버전 : 6.0.0-BETA-2176
echo │  * 탑재된 포지 버전 : 13.20.0.2227
echo │  * 제작날짜 : 2017.02.22
echo │
echo ┕──────────────────────────────
...
java -Xms512M -Xmx512M -jar [Forge]1.11.2-13.20.0.2227_Core.jar
PAUSE
goto main
...
java -Xms1G -Xmx1G -jar [Forge]1.11.2-13.20.0.2227_Core.jar
PAUSE
goto main
...
java -Xms1G -Xmx2G -jar [Forge]1.11.2-13.20.0.2227_Core.jar
PAUSE
goto main
...
java -Xms1G -Xmx4G -jar [Forge]1.11.2-13.20.0.2227_Core.jar
PAUSE
goto main
...
java -Xms1G -Xmx8G -jar [Forge]1.11.2-13.20.0.2227_Core.jar
PAUSE
goto main
...
java -Xms1G -Xmx16G -jar [Forge]1.11.2-13.20.0.2227_Core.jar
PAUSE
goto main
...
:JAVA64
cls
explorer "https://www.fmforum.net/board_info/388965"
goto RAM
...
:way
cls
explorer https://www.fmforum.net/server_tip/28048
goto main
